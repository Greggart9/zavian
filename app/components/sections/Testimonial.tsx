        ...
        <section className="flex flex-col items-center justify-center gap-10 py-20 bg-white w-full px-10 ">
            ...
            <div className="text-center">                                                                                                                                   
                <div className="relative inline-flex items-center px-3">
                    ...
                    <span className="text-sm font-thin tracking-widest text-gray-500">TESTIMONIALS</span>
                </div>

                <p className="text-6xl font-thin pt-3">What Clients Say</p>
                <p className="text-6xl font-thin text-custom1 pt-4">Boldly</p>
            ...
            <div className="flex gap-5 justify-center h-97.75  mt-10">
                ...
                <div className="relative w-86.25 h-full border-4 border-white p-10 shadow-xl overflow-hidden">
                    ...
                    {/* Content */}
                    <div className="relative z-20 h-full flex flex-col justify-between pb-20">
                        {/* Top — avatar + name */}
                        ...
                        {/* Quote */}
                        <p className="text-white text-[20px] font-thin leading-6.5">
                         ...
                         {/* Opening quote mark */}
                           ...
                           {/* Top — avatar + name */}
                            <div className="flex items-center gap-3">
                                ...
                                <p className="text-black/70 text-[15px]">Model & Actor</p>
                                </div>
                            </div>
                        ...
                        {/* Opening quote mark */}
                           ...
                           {/* Top — avatar + name */}
                            <div className="flex items-center gap-3">
                                ...
                                <p className="text-black/70 text-[15px]">Freelance Writer</p>
                                </div>
                            </div>
